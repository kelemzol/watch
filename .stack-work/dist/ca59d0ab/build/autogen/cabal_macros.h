...
/* package watch-0.1.0.0 */
#define VERSION_watch "0.1.0.0"
#define MIN_VERSION_watch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "watch-0.1.0.0"

#define CURRENT_PACKAGE_KEY "watch-0.1.0.0"
